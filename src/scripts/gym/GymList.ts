...
GymList['Mossdeep City'] = new Gym(
    ...
    'Mossdeep City',
    [
        new GymPokemon('Claydol', 1053000, 41),
        new GymPokemon('Xatu', 1054500, 41),
        new GymPokemon('Lunatone', 1053000, 42),
        new GymPokemon('Solrock', 1054500, 42),
    ],
    BadgeEnums.Mind,
    8000,
...
GymList['Cipher Admin Ein'] = new Gym (
    ...
    'Cipher Admin Ein',
    [
        new GymPokemon('Crobat', 18149280, 48),
        new GymPokemon('Pelipper', 18149280, 49),
        new GymPokemon('Rhydon', 18149280, 50),
        new GymPokemon('Starmie', 18149280, 49),
        new GymPokemon('Manectric', 18149280, 50),
    ],
    BadgeEnums.Elite_F_Disk,
    10000,
    'Urrrgh… What unbelievable power…',
    [new QuestLineCompletedRequirement('Shadows in the Desert')],
    undefined, { doubleBattle: true }, { displayName: 'Challenge Ein' }
);
GymList['Cipher Admin Miror B.'] = new Gym (
    'Cipher Admin Miror B',
    'Cipher Admin Miror B.',
    [
        new GymPokemon('Ludicolo', 17399280, 44),
        new GymPokemon('Ludicolo', 17399280, 45),
        new GymPokemon('Loudred', 17399280, 46),
        new GymPokemon('Golduck', 17399280, 45),
        new GymPokemon('Armaldo', 17399280, 43),
    ],
    BadgeEnums.Elite_L_Disk,
    10000,
    'I\'m an awesome dancer… But I can\'t win in battles!',
    [new QuestLineCompletedRequirement('Shadows in the Desert')],
    undefined, { doubleBattle: true }, { displayName: 'Challenge Miror B.' }
);
GymList['Cipher Admin Dakim'] = new Gym (
    'Cipher Admin Dakim',
    'Cipher Admin Dakim',
    [
        new GymPokemon('Claydol', 17999280, 46),
        new GymPokemon('Forretress', 17999280, 45),
        new GymPokemon('Flygon', 17999280, 46),
        new GymPokemon('Whiscash', 17999280, 46),
        new GymPokemon('Houndoom', 17999280, 47),
    ],
    BadgeEnums.Elite_R_Disk,
    10000,
    'This can\'t be! The mighty Dakim loses again?',
    [new QuestLineCompletedRequirement('Shadows in the Desert')],
    undefined, { doubleBattle: true }, { displayName: 'Challenge Dakim' }
);
GymList['Cipher Admin Venus'] = new Gym (
    'Cipher Admin Venus',
    'Cipher Admin Venus',
    [
        new GymPokemon('Bellossom', 18449280, 47),
        new GymPokemon('Misdreavus', 18449280, 47),
        new GymPokemon('Raichu', 18449280, 48),
        new GymPokemon('Wigglytuff', 18449280, 48),
        new GymPokemon('Milotic', 18449280, 48),
    ],
    BadgeEnums.Elite_U_Disk,
    10000,
    'I shall forget that I ever battled with you. Yes, that\'s what I\'ll do. Ohohohoh!',
    [new QuestLineCompletedRequirement('Shadows in the Desert')],
    undefined, { doubleBattle: true }, { displayName: 'Challenge Venus' }
);
GymList['Cipher Admin Lovrina'] = new Gym ( //Kalos E4 difficulty, plus 10% per Orre Colosseum boss
    'Cipher Admin Lovrina',
    'Cipher Admin Lovrina',
    [
        new GymPokemon('Shuckle', 46492422, 100),
        new GymPokemon('Milotic', 46492422, 100),
        new GymPokemon('Wobbuffet', 46492422, 100),
        new GymPokemon('Blissey', 46492422, 100),
        new GymPokemon('Misdreavus', 46492422, 100),
        new GymPokemon('Meganium', 46492422, 100),
    ],
    ...
    undefined, { doubleBattle: true }, { displayName: 'Challenge Lovrina' }
);
GymList['Cipher Admin Snattle'] = new Gym (
    'Cipher Admin Snattle',
    'Cipher Admin Snattle',
    [
        new GymPokemon('Electrode', 51141665, 100),
        new GymPokemon('Gengar', 51141665, 100),
        new GymPokemon('Muk', 51141665, 100),
        new GymPokemon('Glalie', 51141665, 100),
        new GymPokemon('Regirock', 51141665, 100),
        new GymPokemon('Regice', 51141665, 100),
    ],
    ...
    undefined, { doubleBattle: true }, { displayName: 'Challenge Snattle' }
);
GymList['Cipher Admin Gorigan'] = new Gym (
    'Cipher Admin Gorigan',
    'Cipher Admin Gorigan',
    [
        new GymPokemon('Salamence', 56255831, 100),
        new GymPokemon('Granbull', 56255831, 100),
        new GymPokemon('Arcanine', 56255831, 100),
        new GymPokemon('Tauros', 56255831, 100),
        new GymPokemon('Hitmontop', 56255831, 100),
        new GymPokemon('Gyarados', 56255831, 100),
    ],
    ...
    undefined, { doubleBattle: true }, { displayName: 'Challenge Gorigan' }
);
GymList['Cipher Admin Ardos'] = new Gym (
    'Cipher Admin Ardos',
    'Cipher Admin Ardos',
    [
        new GymPokemon('Sceptile', 61881414, 100),
        new GymPokemon('Charizard', 61881414, 100),
        new GymPokemon('Gengar', 61881414, 100),
        new GymPokemon('Aerodactyl', 61881414, 100),
        new GymPokemon('Tauros', 61881414, 100),
        new GymPokemon('Starmie', 61881414, 100),
    ],
    ...
    undefined, { doubleBattle: true }, { displayName: 'Challenge Ardos' }
);
GymList['Cipher Admin Eldes'] = new Gym (
    'Cipher Admin Eldes',
    'Cipher Admin Eldes',
    [
        new GymPokemon('Latios', 68069556, 100),
        new GymPokemon('Latias', 68069556, 100),
        new GymPokemon('Gengar', 68069556, 100),
        new GymPokemon('Metagross', 68069556, 100),
        new GymPokemon('Snorlax', 68069556, 100),
        new GymPokemon('Tauros', 68069556, 100),
    ],
    ...
    undefined, { doubleBattle: true }, { displayName: 'Challenge Eldes' }
);
//Sinnoh Gyms
...
GymList.Hammerlocke = new Gym(
    ...
    'Hammerlocke',
    [
        new GymPokemon('Gigalith', 226914920, 46),
        new GymPokemon('Flygon', 226914920, 47),
        new GymPokemon('Sandaconda', 226914920, 46),
        new GymPokemon('Gigantamax Duraludon', 245438660, 48),
    ],
