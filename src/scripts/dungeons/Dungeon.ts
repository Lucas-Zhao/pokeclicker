...
dungeonList['Victory Road'] = new Dungeon('Victory Road',
    ...
    [
        ...
        new DungeonTrainer('Cool Couple',
            ...
            ], { weight: 1, doubleBattle: true }, 'Ray & Tyra'),
        new DungeonBossPokemon('Pikachu (Easter)', 2700000, 23, {
            requirement: new MultiRequirement([
...
dungeonList['Meteor Falls'] = new Dungeon('Meteor Falls',
    [
        ...
        new DungeonTrainer('Old Couple',
            ...
            ], { weight: 1, doubleBattle: true }, 'John and Jay'),
    ],
    {
        common: [
...
dungeonList['Mt. Pyre'] = new Dungeon('Mt. Pyre',
    [
        ...
        new DungeonTrainer('Psychic',
            ...
            { weight: 1, doubleBattle: true }, 'Kayla', '(female)'),
        new DungeonTrainer('Pokémon Breeder',
            [
...
dungeonList['Phenac City Battles'] = new Dungeon('Phenac City Battles',
    [
        ...
        new DungeonTrainer('Team Snagem',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less)}, 'Wakin'),
        new DungeonTrainer('Miror B. Peon',
            [
                new GymPokemon('Whismur', 38000, 26),
                new GymPokemon('Lotad', 38000, 25),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(75, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less)}, 'Folly', '(folly)'),
        new DungeonTrainer('Mystery Troop Green',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Verde'),
        new DungeonTrainer('Mystery Troop Red',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Rosso'),
        new DungeonTrainer('Mystery Troop Blue',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Bluno'),
        new DungeonTrainer('Miror B. Peon',
            [
                new GymPokemon('Exploud', 38000, 53),
                new GymPokemon('Ludicolo', 38000, 55),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less)}, 'Folly', '(folly)'),
        new DungeonTrainer('Miror B. Peon',
            [
                new GymPokemon('Dusclops', 38000, 54),
                new GymPokemon('Spinarak', 38000, 53),
                new GymPokemon('Machoke', 38000, 53),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(125, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less)}, 'Trudly', '(trudly)'),
        new DungeonTrainer('Cipher Peon',
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 12)}, 'Exinn', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 12)}, 'Gonrag', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Ertlig', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Duskull', 38000, 21),
                new GymPokemon('Corphish', 38000, 20),
                new GymPokemon('Qwilfish', 38000, 21),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Forgs', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Sudowoodo', 38000, 20),
                new GymPokemon('Clamperl', 38000, 21),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Pellim', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Mightyena', 38000, 21),
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(225, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Fenton', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Shuppet', 38000, 21),
                new GymPokemon('Teddiursa', 38000, 21),
                new GymPokemon('Corsola', 38000, 21),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Ezoor', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(275, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Kepen', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 12)}, 'Greck', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Slugma', 38000, 20),
                new GymPokemon('Numel', 38000, 20),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(300, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)])}, 'Resix', 'Resix'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Horsea', 38000, 21),
                new GymPokemon('Goldeen', 38000, 20),
                new GymPokemon('Beldum', 38000, 19),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(325, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)])}, 'Blusix', 'Blusix'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Noctowl', 38000, 20),
                new GymPokemon('Vigoroth', 38000, 20),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(350, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)])}, 'Browsix', 'Browsix'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Chinchou', 38000, 20),
                new GymPokemon('Electrike', 38000, 20),
                new GymPokemon('Magnemite', 38000, 20),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(375, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)])}, 'Yellosix', 'Yellosix'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(400, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)])}, 'Purpsix', 'Purpsix'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(425, GameConstants.getDungeonIndex('Phenac City Battles'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)])}, 'Greesix', 'Greesix'),
    ],
    {
        common: [
            {loot: 'xClick'},
    ...
    [
        new DungeonTrainer('Miror B. Peon',
            ...
            ], { weight: 1, doubleBattle: true}, 'Trudly', '(trudly)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 12)}, 'Eloin', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 12)}, 'Fasin', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 12)}, 'Fostin', 'XD (male)'),
    ],
    38000, 110);
...
dungeonList['Pyrite Town Battles'] = new Dungeon('Pyrite Town Battles',
    [
        new DungeonTrainer('Chaser',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(25, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Calda', '(male)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Gulpin', 41000, 27),
                new GymPokemon('Zubat', 41000, 27),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Emok', '(female)'),
        new DungeonTrainer('Rider',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Vant', '(male)'),
        new DungeonTrainer('Bandana Guy',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Divel'),
        new DungeonTrainer('Roller Boy',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Lon'),
        new DungeonTrainer('Rider',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Nover', '(male)'),
        new DungeonTrainer('Street Performer',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Diogo'),
        new DungeonTrainer('Rider',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Leba', '(female)'),
        new DungeonTrainer('Bodybuilder',
            [
                new GymPokemon('Beldum', 41000, 34),
                new GymPokemon('Aron', 41000, 35),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(75, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Hadar', '(male)'),
        new DungeonTrainer('Rogue',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Cail', 'Cail'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Furret', 41000, 35),
                new GymPokemon('Taillow', 41000, 32),
                new GymPokemon('Slakoth', 41000, 21),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(125, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Calda', '(male)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Gulpin', 41000, 36),
                new GymPokemon('Golbat', 41000, 36),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Emok', '(female)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Skitty', 41000, 28),
                new GymPokemon('Zigzagoon', 41000, 28),
                new GymPokemon('Shuppet', 41000, 29),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Vant', '(male)'),
        new DungeonTrainer('Bandana Guy',
            [
                new GymPokemon('Psyduck', 41000, 29),
                new GymPokemon('Horsea', 41000, 30),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Divel'),
        new DungeonTrainer('Roller Boy',
            [
                new GymPokemon('Igglybuff', 41000, 28),
                ...
                new GymPokemon('Azurill', 41000, 27),
                new GymPokemon('Swablu', 41000, 27),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(225, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Lon'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Doduo', 41000, 26),
                new GymPokemon('Ledyba', 41000, 27),
                new GymPokemon('Wingull', 41000, 27),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Nover', '(male)'),
        new DungeonTrainer('Street Performer',
            [
                new GymPokemon('Pichu', 41000, 27),
                new GymPokemon('Shroomish', 41000, 26),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(275, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Diogo'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Sunkern', 41000, 28),
                new GymPokemon('Oddish', 41000, 26),
                new GymPokemon('Dustox', 41000, 26),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(300, GameConstants.getDungeonIndex('Pyrite Town Battles'), GameConstants.AchievementOption.less)}, 'Leba', '(female)'),
    ],
    {
        common: [
            {loot: 'xAttack'},
    ...
    [
        new DungeonTrainer('Rogue',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Cail', 'Cail'),
    ],
    41000, 116);
...
dungeonList['Pyrite Colosseum'] = new Dungeon('Pyrite Colosseum',
    ...
    [
        new DungeonTrainer('Bodybuilder',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Mirez', '(male)'),
    ],
    43000, 121);
...
dungeonList['Pyrite Building'] = new Dungeon('Pyrite Building',
    [
        new DungeonTrainer('Cipher Peon',
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Nore', '(male)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Phanpy', 45000, 31),
                new GymPokemon('Trapinch', 45000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(25, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less)}, 'Kai', '(female)'),
        new DungeonTrainer('Roller Boy',
            [
                new GymPokemon('Taillow', 45000, 33),
                new GymPokemon('Hoothoot', 45000, 34),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less) }, 'Pike'),
        new DungeonTrainer('Bandana Guy',
            [
                new GymPokemon('Larvitar', 45000, 31),
                new GymPokemon('Barboach', 45000, 32),
                new GymPokemon('Carvanha', 45000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(75, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less) }, 'Geats'),
        new DungeonTrainer('Bandana Guy',
            [
                new GymPokemon('Wingull', 45000, 32),
                new GymPokemon('Wooper', 45000, 33),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less) }, 'Loba'),
        new DungeonTrainer('Bodybuilder',
            [
                new GymPokemon('Electrike', 45000, 31),
                new GymPokemon('Voltorb', 45000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(125, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less) }, 'Akmen', '(male)'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Doduo', 45000, 32),
                new GymPokemon('Ledyba', 45000, 32),
                new GymPokemon('Swablu', 45000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less) }, 'Raleen', '(female)'),
        new DungeonTrainer('Hunter',
            [
                new GymPokemon('Spheal', 45000, 31),
                new GymPokemon('Snorunt', 45000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less) }, 'Tura', '(male)'),
        new DungeonTrainer('Hunter',
            [
                new GymPokemon('Horsea', 45000, 31),
                new GymPokemon('Oddish', 45000, 32),
                new GymPokemon('Sandshrew', 45000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less) }, 'Toti', '(female)'),
        new DungeonTrainer('Bodybuilder',
            [
                new GymPokemon('Cacnea', 45000, 32),
                new GymPokemon('Tentacool', 45000, 33),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(225, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less) }, 'Elidi', '(female)'),
        new DungeonTrainer('Miror B. Peon',
            [
            ...
            ], { weight: 0.5, doubleBattle: true}, 'Reath', '(reath)'),
        new DungeonTrainer('Miror B. Peon',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Ferma', '(ferma)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Carvanha', 45000, 18),
                new GymPokemon('Barboach', 45000, 17),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Rett', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Corphish', 45000, 18),
                new GymPokemon('Electrike', 45000, 17),
                new GymPokemon('Grimer', 45000, 18),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(275, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Mocor', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 10)}, 'Torkin', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Doduo', 45000, 20),
                new GymPokemon('Tentacool', 45000, 18),
                new GymPokemon('Chimecho', 45000, 20),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(300, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Elox', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(325, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Rixor', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 10)}, 'Mesin', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(350, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Dilly', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(375, GameConstants.getDungeonIndex('Pyrite Building'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Edlos', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 10)}, 'Lobar', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 10)}, 'Feldas', 'XD (male)'),
    ],
    {
        common: [
            {loot: 'xAttack'},
    ...
    [
        new DungeonTrainer('Hunter',
            ...
            ], { weight: 1, doubleBattle: true }, 'Doken', '(male)'),
        new DungeonTrainer('Cipher',
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 10)}, 'Commander Exol', '(commander)'),
    ],
    45000, 126);
...
dungeonList['Pyrite Cave'] = new Dungeon('Pyrite Cave',
    [
        new DungeonTrainer('Street Performer',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(25, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Simes'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Koffing', 46000, 32),
                new GymPokemon('Ralts', 46000, 31),
                new GymPokemon('Shroomish', 46000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Maiz', '(male)'),
        new DungeonTrainer('Rider',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Twan', '(male)'),
        new DungeonTrainer('Hunter',
            [
                new GymPokemon('Lotad', 46000, 32),
                new GymPokemon('Whismur', 46000, 33),
                new GymPokemon('Slakoth', 46000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(75, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Valen', '(male)'),
        new DungeonTrainer('Chaser',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Rehan', '(female)'),
        new DungeonTrainer('Bandana Guy',
            [
                new GymPokemon('Lotad', 46000, 32),
                ...
                new GymPokemon('Lotad', 46000, 33),
                new GymPokemon('Lotad', 46000, 33),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(125, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Noxy'),
        new DungeonTrainer('Rider',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Sosh', '(female)'),
        new DungeonTrainer('Roller Boy',
            [
                new GymPokemon('Lotad', 46000, 32),
                new GymPokemon('Lombre', 46000, 33),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Evat'),
        new DungeonTrainer('Hunter',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Zalo', '(male)'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Shuppet', 46000, 33),
                new GymPokemon('Pineco', 46000, 30),
                new GymPokemon('Koffing', 46000, 30),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Derid', '(male)'),
        new DungeonTrainer('Hunter',
            [
                new GymPokemon('Zigzagoon', 46000, 32),
                new GymPokemon('Zigzagoon', 46000, 32),
                new GymPokemon('Linoone', 46000, 33),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Meli', '(female)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Natu', 46000, 33),
                new GymPokemon('Tentacool', 46000, 32),
                new GymPokemon('Teddiursa', 46000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(225, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Mela', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Lileep', 46000, 32),
                new GymPokemon('Spheal', 46000, 34),
                new GymPokemon('Dustox', 46000, 33),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Pyrite Cave'), GameConstants.AchievementOption.less) }, 'Sema', '(female)'),
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineCompletedRequirement('Gale of Darkness')}, 'Miror B.', 'Miror B'),
    ],
    {
        common: [
            {loot: 'Token_collector'},
    ...
    [
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 1, doubleBattle: true }, 'Miror B.', 'Miror B'),
        new DungeonTrainer('Peon',
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineCompletedRequirement('Shadows in the Desert')}, 'Mirakle B.', '(mirakle b)'),
    ],
    46000, 131);
...
dungeonList['Relic Cave'] = new Dungeon('Relic Cave',
    ...
    [
        new DungeonTrainer('Cipher Peon',
            ...
            ], { weight: 1, doubleBattle: true }, 'Skrub', '(male)'),
    ],
    48000, 131);
...
dungeonList['Mt. Battle'] = new Dungeon('Mt. Battle',
    [
        ...
        new DungeonTrainer('Rider',
            ...
            ], { weight: 1, doubleBattle: true }, 'Riden', '(male)'),
        new DungeonTrainer('Hunter',
            [
        ...
        new DungeonTrainer('Cipher Peon',
            ...
            ], { weight: 1, doubleBattle: true }, 'Kison', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Geodude', 52000, 36),
                new GymPokemon('Geodude', 52000, 36),
                new GymPokemon('Sandslash', 52000, 38),
            ], { weight: 1, doubleBattle: true }, 'Berin', '(male)'),
    ],
    {
        common: [
            {loot: 'xAttack'},
    ...
    [
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 1, doubleBattle: true }, 'Dakim', 'Dakim'),
    ],
    52000, 131);
...
dungeonList['The Under'] = new Dungeon('The Under',
    [
        new DungeonTrainer('Hunter',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('The Under'), GameConstants.AchievementOption.less) }, 'Zada', '(female)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Magikarp', 57000, 36),
                new GymPokemon('Wailord', 57000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('The Under'), GameConstants.AchievementOption.less) }, 'Gurks', '(male)'),
        new DungeonTrainer('Hunter',
            [
                new GymPokemon('Skitty', 57000, 35),
                new GymPokemon('Oddish', 57000, 34),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('The Under'), GameConstants.AchievementOption.less) }, 'Zada', '(female)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Feebas', 57000, 36),
                new GymPokemon('Wailord', 57000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('The Under'), GameConstants.AchievementOption.less) }, 'Gurks', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Kloak', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Ariados', 57000, 38),
                new GymPokemon('Illumise', 57000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('The Under'), GameConstants.AchievementOption.less) }, 'Dagur', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Gloom', 57000, 39),
                new GymPokemon('Illumise', 57000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(300, GameConstants.getDungeonIndex('The Under'), GameConstants.AchievementOption.less) }, 'Dagur', '(female)'),
        new DungeonTrainer('Hunter',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Frena', '(female)'),
        new DungeonTrainer('Chaser',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Liaks', '(female)'),
        new DungeonTrainer('Bodybuilder',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Lonia', '(female)'),
        new DungeonTrainer('Rider',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Nelis', '(female)'),
    ],
    {
        common: [
            {loot: 'Lucky_incense'},
    ...
    [
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 1, doubleBattle: true }, 'Venus', 'Venus'),
    ],
    57000, 131);
...
dungeonList['Cipher Lab'] = new Dungeon('Cipher Lab',
    [
        new DungeonTrainer('Scientist',
            [
                ...
                new GymPokemon('Voltorb', 62000, 38),
            ], { weight: 1, doubleBattle: true }, 'Myron', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Cole', '(female)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Electrode', 62000, 39),
                new GymPokemon('Magneton', 62000, 39),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Odlow', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Magnemite', 62000, 39),
                new GymPokemon('Magneton', 62000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(75, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Coren', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Chinchou', 62000, 38),
                new GymPokemon('Magnemite', 62000, 37),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Lethco', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Electrode', 62000, 39),
                new GymPokemon('Magnemite', 62000, 38),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(125, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Odlow', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Electrode', 62000, 40),
                new GymPokemon('Magneton', 62000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Coren', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Chinchou', 62000, 38),
                new GymPokemon('Electrike', 62000, 39),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Lethco', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Lare', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Vana', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Lesar', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Tanie', '(female)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Electrode', 62000, 37),
                new GymPokemon('Electrode', 62000, 37),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Dubik', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Magneton', 62000, 40),
                new GymPokemon('Ampharos', 62000, 41),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(225, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Kotan', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Electrode', 62000, 42),
                new GymPokemon('Ampharos', 62000, 41),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less) }, 'Kotan', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true }, 'Remil', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Slugma', 62000, 14),
                new GymPokemon('Houndour', 62000, 17, undefined, undefined, GameConstants.ShadowStatus.Shadow),
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Resix', 'Resix'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Blusix', 'Blusix'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Hoothoot', 62000, 14),
                new GymPokemon('Baltoy', 62000, 17, undefined, undefined, GameConstants.ShadowStatus.Shadow),
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Browsix', 'Browsix'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Yellosix', 'Yellosix'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Purpsix', 'Purpsix'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Greesix', 'Greesix'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Duskull', 62000, 14),
                new GymPokemon('Skitty', 62000, 14),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(275, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Corla', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Doduo', 62000, 13),
                new GymPokemon('Taillow', 62000, 14),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(300, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Javion', 'XD (female)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Lileep', 62000, 13),
                new GymPokemon('Anorith', 62000, 13),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(325, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Mesak', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Nexir', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Solox', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Snorunt', 62000, 14),
                new GymPokemon('Barboach', 62000, 14),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(350, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Crink', 'XD (male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Spoink', 62000, 16),
                new GymPokemon('Lotad', 62000, 14),
                new GymPokemon('Staryu', 62000, 14),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(375, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Morbit', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Natu', 62000, 16),
                new GymPokemon('Nincada', 62000, 14),
                new GymPokemon('Wailmer', 62000, 15),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(400, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Meda', 'XD (female)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Swablu', 62000, 17),
                new GymPokemon('Wynaut', 62000, 16),
                new GymPokemon('Corsola', 62000, 15),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(425, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Elrok', '(male)'),
        new DungeonTrainer('Scientist',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(450, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Coffy', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(475, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Digor', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Cabol', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Jigglypuff', 62000, 15),
                new GymPokemon('Chimecho', 62000, 17),
                new GymPokemon('Dunsparce', 62000, 16),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(500, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Nopia', 'XD (female)'),
        new DungeonTrainer('Scientist',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6) }, 'Klots', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Clamperl', 62000, 13),
                new GymPokemon('Corphish', 62000, 14),
                new GymPokemon('Zubat', 62000, 15),
            ], { weight: 1, doubleBattle: true, requirement: new MultiRequirement([new ClearDungeonRequirement(525, GameConstants.getDungeonIndex('Cipher Lab'), GameConstants.AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Tekot', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6) }, 'Naps', '(yellow)'),
    ],
    {
        common: [
            {loot: 'Token_collector'},
    ...
    [
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 1, doubleBattle: true }, 'Ein', 'Ein'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 6)}, 'Lovrina', 'Lovrina'),
    ],
    62000, 131);
...
dungeonList['Realgam Tower Battles'] = new Dungeon('Realgam Tower Battles',
    [
        new DungeonTrainer('Cipher Peon',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(25, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Bopen', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Dustox', 70000, 38),
                new GymPokemon('Seviper', 70000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Bopen', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Arton', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Baila', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Dioge', '(male)'),
        new DungeonTrainer('Mystery Troop Green',
            [
                new GymPokemon('Muk', 70000, 45),
                new GymPokemon('Grumpig', 70000, 44),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Verde'),
        new DungeonTrainer('Mystery Troop Red',
            [
                new GymPokemon('Muk', 70000, 45),
                new GymPokemon('Grumpig', 70000, 44),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Rosso'),
        new DungeonTrainer('Mystery Troop Blue',
            [
                new GymPokemon('Muk', 70000, 45),
                new GymPokemon('Grumpig', 70000, 44),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Bluno'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Shelgon', 70000, 40),
                new GymPokemon('Vigoroth', 70000, 41),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Rugen', '(male)'),
        new DungeonTrainer('Bandana Guy',
            [
                new GymPokemon('Hariyama', 70000, 41),
                new GymPokemon('Lombre', 70000, 42),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Klest'),
        new DungeonTrainer('Bandana Guy',
            [
                new GymPokemon('Nuzleaf', 70000, 39),
                new GymPokemon('Graveler', 70000, 42),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Klest'),
        new DungeonTrainer('Hunter',
            [
                new GymPokemon('Metang', 70000, 39),
                new GymPokemon('Mawile', 70000, 40),
                new GymPokemon('Lairon', 70000, 41),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(225, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Aline', '(female)'),
        new DungeonTrainer('Street Performer',
            [
                new GymPokemon('Seadra', 70000, 39),
                new GymPokemon('Feraligatr', 70000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Luper'),
        new DungeonTrainer('Street Performer',
            [
                new GymPokemon('Qwilfish', 70000, 40),
                new GymPokemon('Octillery', 70000, 39),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(275, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Luper'),
        new DungeonTrainer('Bodybuilder',
            [
                new GymPokemon('Loudred', 70000, 45),
                new GymPokemon('Wigglytuff', 70000, 43),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(300, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Givern', '(male)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Ninetales', 70000, 40),
                new GymPokemon('Machoke', 70000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(325, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Trus', '(male)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Swellow', 70000, 40),
                new GymPokemon('Magneton', 70000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(350, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Trus', '(male)'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Quagsire', 70000, 41),
                new GymPokemon('Donphan', 70000, 40),
                new GymPokemon('Sandslash', 70000, 40),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(375, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Kevel', '(male)'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Swalot', 70000, 40),
                new GymPokemon('Chimecho', 70000, 41),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(400, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Elose', '(female)'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Cradily', 70000, 41),
                new GymPokemon('Noctowl', 70000, 41),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(425, GameConstants.getDungeonIndex('Realgam Tower Battles'), GameConstants.AchievementOption.less) }, 'Elose', '(female)'),
    ],
    {
        common: [
            {loot: 'xAttack'},
    ...
    [
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineCompletedRequirement('Shadows in the Desert', GameConstants.AchievementOption.less) }, 'Ein', 'Ein'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineCompletedRequirement('Shadows in the Desert', GameConstants.AchievementOption.less) }, 'Miror B.', 'Miror B'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineCompletedRequirement('Shadows in the Desert', GameConstants.AchievementOption.less) }, 'Dakim', 'Dakim'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 1, doubleBattle: true, hide: true,  requirement: new QuestLineCompletedRequirement('Shadows in the Desert', GameConstants.AchievementOption.less) }, 'Venus', 'Venus'),
        new DungeonTrainer('Snagem Head',
            ...
            ], { weight: 1, doubleBattle: true }, 'Gonzap', '(gonzap)'),
    ],
    70000, 131);
...
dungeonList['Realgam Colosseum'] = new Dungeon('Realgam Colosseum',
    [
        new DungeonTrainer('Bodybuilder',
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Jomas', '(female)'),
        new DungeonTrainer('Rider',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Delan', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Nella', '(female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.5, doubleBattle: true }, 'Ston', '(male)'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 0.5, doubleBattle: true,  requirement: new QuestLineCompletedRequirement('Gale of Darkness') }, 'Miror B.', 'Miror B'),
    ],
    {
        common: [
            {loot: 'Lucky_incense'},
    ...
    [
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 1, doubleBattle: true }, 'Nascour', '(nascour)'),
        new DungeonTrainer('Cipher Head',
            ...
            ], { weight: 1, doubleBattle: true }, 'Evice', '(evice)'),
    ],
    75200, 134);
...
dungeonList['Snagem Hideout'] = new Dungeon('Snagem Hideout',
    [
        new DungeonTrainer('Team Snagem',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(25, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Driton'),
        new DungeonTrainer('Bodybuilder',
            [
                new GymPokemon('Shelgon', 80200, 54),
                new GymPokemon('Carvanha', 80200, 51),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Colas', '(male)'),
        new DungeonTrainer('Bandana Guy',
            [
                new GymPokemon('Weezing', 80200, 52),
                new GymPokemon('Swalot', 80200, 51),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(75, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Crudo'),
        new DungeonTrainer('Team Snagem',
            [
                new GymPokemon('Vigoroth', 80200, 52),
                new GymPokemon('Zangoose', 80200, 53),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Niver'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Mightyena', 80200, 50),
                new GymPokemon('Linoone', 80200, 53),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(125, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Rions', '(male)'),
        new DungeonTrainer('Team Snagem',
            [
                new GymPokemon('Swellow', 80200, 54),
                new GymPokemon('Golbat', 80200, 53),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Fuston'),
        new DungeonTrainer('Team Snagem',
            [
                new GymPokemon('Seadra', 80200, 55),
                new GymPokemon('Pelipper', 80200, 53),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Driton'),
        new DungeonTrainer('Bodybuilder',
            [
                new GymPokemon('Pupitar', 80200, 54),
                new GymPokemon('Spinda', 80200, 51),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Colas', '(male)'),
        new DungeonTrainer('Bandana Guy',
            [
                new GymPokemon('Sandslash', 80200, 53),
                new GymPokemon('Linoone', 80200, 55),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(225, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Crudo'),
        new DungeonTrainer('Team Snagem',
            [
                new GymPokemon('Grovyle', 80200, 52),
                new GymPokemon('Rhyhorn', 80200, 52),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Niver'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Poochyena', 80200, 54),
                new GymPokemon('Kadabra', 80200, 53),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(275, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Rions', '(male)'),
        new DungeonTrainer('Team Snagem',
            [
                new GymPokemon('Beautifly', 80200, 53),
                new GymPokemon('Delibird', 80200, 54),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(300, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Fuston'),
        new DungeonTrainer('Mystery Troop Green',
            [
        ...
        new DungeonTrainer('Bodybuilder',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(325, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Lonia', '(female)'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Seviper', 80200, 52),
                new GymPokemon('Sharpedo', 80200, 50),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(350, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Nelis', '(female)'),
        new DungeonTrainer('Hunter',
            [
                new GymPokemon('Mawile', 80200, 53),
                new GymPokemon('Donphan', 80200, 51),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(375, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Frena', '(female)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Jumpluff', 80200, 53),
                new GymPokemon('Noctowl', 80200, 52),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(400, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Liaks', '(female)'),
        new DungeonTrainer('Bodybuilder',
            [
                new GymPokemon('Flaaffy', 80200, 55),
                new GymPokemon('Dunsparce', 80200, 51),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(425, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Lonia', '(female)'),
        new DungeonTrainer('Rider',
            [
                new GymPokemon('Corsola', 80200, 51),
                new GymPokemon('Loudred', 80200, 54),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(450, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Nelis', '(female)'),
        new DungeonTrainer('Hunter',
            [
                new GymPokemon('Jigglypuff', 80200, 52),
                new GymPokemon('Shroomish', 80200, 53),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(475, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Frena', '(female)'),
        new DungeonTrainer('Chaser',
            [
                new GymPokemon('Gloom', 80200, 53),
                new GymPokemon('Golduck', 80200, 53),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(500, GameConstants.getDungeonIndex('Snagem Hideout'), GameConstants.AchievementOption.less) }, 'Liaks', '(female)'),
        new DungeonTrainer('Team Snagem',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Biden'),
        new DungeonTrainer('Team Snagem',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Agrev'),
    ],
    {
        common: [
            {loot: 'xAttack'},
...
dungeonList['Deep Colosseum'] = new Dungeon('Deep Colosseum',
    ...
    [
        new DungeonTrainer('Deep King',
            ...
            ], { weight: 1, doubleBattle: true}, 'Angol', '(angol)'),
    ],
    88800, 134);
...
dungeonList['Phenac Stadium'] = new Dungeon('Phenac Stadium',
    [
        ...
        new DungeonTrainer('Cipher Peon',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 13)}, 'Ezin', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 13)}, 'Faltly', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 13)}, 'Egrog', '(yellow)'),
    ],
    {
        common: [
            {loot: 'xAttack'},
    ...
    [
        new DungeonTrainer('Chaser',
            ...
            ], { weight: 1, doubleBattle: true }, 'Crelf', '(male)'),
        new DungeonTrainer('Hunter',
            [
            ...
            ], { weight: 1, doubleBattle: true }, 'Harle', '(female)'),
        new DungeonTrainer('Bodybuilder',
            [
            ...
            ], { weight: 1, doubleBattle: true }, 'Bodhi', '(male)'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineStepCompletedRequirement('Gale of Darkness', 13)}, 'Snattle', 'Snattle'),
    ],
    89500, 134);
...
dungeonList['Under Colosseum'] = new Dungeon('Under Colosseum',
    ...
    [
        new DungeonTrainer('Shady Guy',
            ...
            ], { weight: 1, doubleBattle: true }, 'Fein', '(wes)'),
    ],
    91500, 134);
...
dungeonList['Gateon Port Battles'] = new Dungeon('Gateon Port Battles',
    [
        new DungeonTrainer('Chaser',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(25, GameConstants.getDungeonIndex('Gateon Port Battles'), GameConstants.AchievementOption.less) }, 'Laken', '(female)'),
        new DungeonTrainer('Sailor',
            [
                new GymPokemon('Wingull', 6002000, 6),
                new GymPokemon('Lotad', 6002000, 6),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Gateon Port Battles'), GameConstants.AchievementOption.less) }, 'Berk'),
        new DungeonTrainer('Sailor',
            [
                new GymPokemon('Whismur', 6002000, 6),
                new GymPokemon('Marill', 6002000, 6),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(75, GameConstants.getDungeonIndex('Gateon Port Battles'), GameConstants.AchievementOption.less) }, 'Bost'),
        new DungeonTrainer('Old Man',
            [
                new GymPokemon('Taillow', 80200, 6),
                new GymPokemon('Ledyba', 80200, 10, undefined, undefined, GameConstants.ShadowStatus.Shadow),
            ], { weight: 0.25, doubleBattle: true}, 'Cyle'),
        new DungeonTrainer('Bodybuilder',
            [
                new GymPokemon('Zubat', 80200, 6),
                new GymPokemon('Poochyena', 80200, 10, undefined, undefined, GameConstants.ShadowStatus.Shadow),
            ], { weight: 0.25, doubleBattle: true}, 'Kilen', '(female)'),
    ],
    {
        common: [
            {loot: 'xAttack'},
    ...
    [
        ...
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 1, doubleBattle: true, hide: true, requirement: new QuestLineCompletedRequirement('Gale of Darkness')}, 'Miror B.', 'Miror B'),
    ],
    443500, 134,
    () => {},
...
dungeonList['Cipher Key Lair'] = new Dungeon('Cipher Key Lair',
    [
        new DungeonTrainer('Cipher Peon',
            ...
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(25, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Kollo', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Ledian', 6708000, 28),
                new GymPokemon('Illumise', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Grezle', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Clamperl', 6708000, 31),
                new GymPokemon('Octillery', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(75, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Kollo', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Minun', 6708000, 30),
                new GymPokemon('Beautifly', 6708000, 30),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Grezle', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Humah', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Xatu', 6708000, 31),
                new GymPokemon('Volbeat', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(125, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Ibsol', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Masquerain', 6708000, 31),
                new GymPokemon('Bellossom', 6708000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Jelstin', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Plusle', 6708000, 30),
                new GymPokemon('Dustox', 6708000, 30),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Ibsol', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Roselia', 6708000, 32),
                new GymPokemon('Hoppip', 6708000, 32),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Jelstin', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Gorog', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Lok', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Donphan', 6708000, 30),
                new GymPokemon('Ampharos', 6708000, 31),
                new GymPokemon('Tentacruel', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(225, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Kleto', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Noctowl', 6708000, 30),
                new GymPokemon('Mightyena', 6708000, 29),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Flipis', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Absol', 6708000, 30),
                new GymPokemon('Smeargle', 6708000, 31),
                new GymPokemon('Tentacruel', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(275, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Kleto', 'XD (female)'),
        new DungeonTrainer('Cipher Peon',
            [
                new GymPokemon('Chimecho', 6708000, 31),
                new GymPokemon('Kecleon', 6708000, 30),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(300, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Flipis', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Targ', 'XD (female)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Vileplume', 6708000, 31),
                new GymPokemon('Stantler', 6708000, 31),
                new GymPokemon('Granbull', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(325, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Hospel', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Ariados', 6708000, 30),
                new GymPokemon('Girafarig', 6708000, 29),
                new GymPokemon('Granbull', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(350, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Hospel', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Snidle', 'XD (male)'),
        new DungeonTrainer('Cipher',
            [
                new GymPokemon('Forretress', 6708000, 31),
                new GymPokemon('Mantine', 6708000, 32),
                new GymPokemon('Crobat', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(375, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Peon Fudler', '(commander)'),
        new DungeonTrainer('Cipher',
            [
                new GymPokemon('Machoke', 6708000, 31),
                new GymPokemon('Golem', 6708000, 31),
                new GymPokemon('Forretress', 6708000, 31),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(400, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Peon Fudler', '(commander)'),
        new DungeonTrainer('Cipher',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Peon Angic', '(commander)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Camerupt', 6708000, 35),
                new GymPokemon('Seaking', 6708000, 34),
                new GymPokemon('Piloswine', 6708000, 34),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(425, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Acrod', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Grumpig', 6708000, 34),
                new GymPokemon('Seadra', 6708000, 34),
                new GymPokemon('Camerupt', 6708000, 35),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(450, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Acrod', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Smarton', '(yellow)'),
    ],
    {
        common: [
            {loot: 'xClick'},
    ...
    [
        new DungeonTrainer('Cipher Admin',
            ...
            { weight: 1, doubleBattle: true }, 'Gorigan', 'Gorigan'),
    ],
    513600, 134,
    () => {},
    {dungeonRegionalDifficulty: GameConstants.Region.unova});
...
dungeonList['Citadark Isle'] = new Dungeon('Citadark Isle',
    [
        new DungeonTrainer('Sailor',
            ...
            ], { weight: 1, doubleBattle: true}, 'Abson'),
        new DungeonTrainer('Chaser',
            [
            ...
            ], { weight: 1, doubleBattle: true}, 'Furgy', '(male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true}, 'Litnar', 'XD (male)'),
        new DungeonTrainer('Cipher',
            [
            ...
            ], { weight: 1, doubleBattle: true}, 'Peon Grupel', '(commander)'),
        new DungeonTrainer('Cipher Peon',
            [
        ...
        new DungeonTrainer('Cipher',
            ...
            ], { weight: 1, doubleBattle: true}, 'Peon Petro', '(commander)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true}, 'Geftal', 'XD (male)'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 1, doubleBattle: true}, 'Leden', 'XD (female)'),
        new DungeonTrainer('Sailor',
            [
    ...
    [
        new DungeonTrainer('Cipher Admin',
            ...
            { weight: 1, doubleBattle: true }, 'Lovrina', 'Lovrina'),
    ],
    577700, 134,
    () => {},
    {dungeonRegionalDifficulty: GameConstants.Region.unova});
...
dungeonList['Citadark Isle Dome'] = new Dungeon('Citadark Isle Dome', // Difficulty comperable to Pokéball Factory
    [
        new DungeonTrainer('Cipher Admin',
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Snattle', 'Snattle'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Ardos', 'Ardos'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Gorigan', 'Gorigan'),
        new DungeonTrainer('Cipher Peon',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Kolax', 'XD (male)'),
        new DungeonTrainer('Cipher Admin',
            [
            ...
            ], { weight: 0.25, doubleBattle: true}, 'Eldes', 'Eldes'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Miltank', 8173950, 44),
                new GymPokemon('Armaldo', 8173950, 41),
                new GymPokemon('Slaking', 8173950, 43),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Citadark Isle Dome'), GameConstants.AchievementOption.less) }, 'Loket', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Cradily', 8173950, 44),
                new GymPokemon('Milotic', 8173950, 44),
                new GymPokemon('Gyarados', 8173950, 42),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(150, GameConstants.getDungeonIndex('Citadark Isle Dome'), GameConstants.AchievementOption.less) }, 'Kaller', '(male)'),
        new DungeonTrainer('Cipher Admin',
            [
        ...
        new DungeonTrainer('Scientist',
            [
                ...
                new GymPokemon('Slaking', 8173950, 43),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(200, GameConstants.getDungeonIndex('Citadark Isle Dome'), GameConstants.AchievementOption.less) }, 'Loket', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Corsola', 8173950, 44),
                new GymPokemon('Tentacruel', 8173950, 44),
                new GymPokemon('Gyarados', 8173950, 42),
            ], { weight: 1, doubleBattle: true, requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Citadark Isle Dome'), GameConstants.AchievementOption.less) }, 'Kaller', '(male)'),
    ],
    {
        common: [
            {loot: 'xAttack'},
    ...
    [
        ...
        new DungeonTrainer('Grand Master',
            ...
            { weight: 1, doubleBattle: true, requirement: new QuestLineCompletedRequirement('Gale of Darkness') }, 'Greevil', 'Greevil'),
    ],
    615000, 134,
    () => {},
    {dungeonRegionalDifficulty: GameConstants.Region.unova});
...
dungeonList['Eterna Forest'] = new Dungeon('Eterna Forest',
    [
        ...
        new DungeonTrainer('Bookworms',
            ...
            ], { weight: 1, doubleBattle: true }, 'Jack & Briana'),
        new DungeonTrainer('Melded Minds',
            [
                new GymPokemon('Abra', 812000, 15),
                new GymPokemon('Abra', 812000, 15),
            ], { weight: 1, doubleBattle: true }, 'Linsey & Elijah', '(both)'),
        new DungeonTrainer('Bug Buds',
            ...
            ], { weight: 1, doubleBattle: true }, 'Philip & Donald'),
        new DungeonTrainer('Melded Minds',
            [
                new GymPokemon('Meditite', 812000, 15),
                new GymPokemon('Psyduck', 812000, 15),
            ], { weight: 1, doubleBattle: true }, 'Kody & Rachael', '(both)'),
    ],
    {
        common: [
            {loot: 'Cheri'},
...
dungeonList['Wayward Cave'] = new Dungeon('Wayward Cave',
    [
        ...
        new DungeonTrainer('Mountain Men',
            ...
            ], { weight: 1, doubleBattle: true }, 'Reginald & Lorenzo'),
        ...
        new DungeonTrainer('Amateur Archaeologists',
            ...
            ], { weight: 1, doubleBattle: true }, 'Terry & Gerald'),
    ],
    {
        common: [
            {loot: 'Token_collector'},
...
dungeonList['Iron Island'] = new Dungeon('Iron Island',
    [
        ...
        new DungeonTrainer('Co-workers',
            ...
            ], { weight: 1, doubleBattle: true }, 'Brendon & Quentin'),
        new DungeonTrainer('Ace Duo',
            ...
            ], { weight: 1, doubleBattle: true }, 'Jonah & Brenda'),
    ],
    {
        common: [
            {loot: 'Dowsing_machine', weight: 2},
...
dungeonList['Spear Pillar'] = new Dungeon('Spear Pillar',
    ...
    [
        new DungeonTrainer('Commanders',
            ...
            ], { weight: 1, doubleBattle: true }, 'Mars & Jupiter', '(marsjupiter)'),
...
dungeonList['Victory Road Sinnoh'] = new Dungeon('Victory Road Sinnoh',
    [
        ...
        new DungeonTrainer('Double Team',
            ...
            ], { weight: 1, doubleBattle: true }, 'Al & Kay'),
        new DungeonTrainer('Black Belt',
        ...
        new DungeonTrainer('Double Team',
            ...
            ], { weight: 1, doubleBattle: true }, 'Pat & Jo'),
        new DungeonTrainer('Ace Trainer',
            [
...
dungeonList['Stark Mountain'] = new Dungeon('Stark Mountain',
    [
        ...
        new DungeonTrainer('Fight & Flight',
            ...
            ], { weight: 1, doubleBattle: true }, 'Krystal & Ray'),
        new DungeonTrainer('Ace Duo',
            [
            ...
            ], { weight: 1, doubleBattle: true }, 'Abel & Monique'),
        new DungeonTrainer('Melded Minds',
            [
            ...
            ], { weight: 1, doubleBattle: true }, 'Chelsey & Sterling', '(both)'),
        new DungeonTrainer('Dragon Warriors',
            ...
            ], { weight: 1, doubleBattle: true }, 'Harlan & Kenny'),
        new DungeonTrainer('Ace Duo',
            [
            ...
            ], { weight: 1, doubleBattle: true }, 'Skylar & Narasha'),
        new DungeonTrainer('Hidden Dragons',
            ...
            ], { weight: 1, doubleBattle: true }, 'Drake & Jarrett'),
    ],
    {
        common: [
            {loot: 'Token_collector', weight: 2},
    ...
    [
        ...
        new DungeonTrainer('Twins',
            [
                ...
                new GymPokemon('Swablu', 306500, 38),
            ], { weight: 1, doubleBattle: true }, 'Rae & Ula'),
        new DungeonTrainer('Lass',
            [
...
dungeonList['Pinwheel Forest'] = new Dungeon('Pinwheel Forest',
    [
        ...
        new DungeonTrainer('Twins',
            ...
            ], { weight: 1, doubleBattle: true }, 'Ally & Amy'),
        new DungeonTrainer('Nursery Aide',
            [
...
dungeonList['Reflection Cave'] = new Dungeon('Reflection Cave',
    [
        ...
        new DungeonTrainer('Honeymooners',
            ...
            ], { weight: 1, doubleBattle: true }, 'Yuu & Ami'),
    ],
    {
        common: [
            {loot: 'Token_collector'},
...
dungeonList['Lost Hotel'] = new Dungeon('Lost Hotel',
    ...
    [
        new DungeonTrainer('Punk Couple',
            ...
            ], { weight: 2, doubleBattle: true }, 'Zoya & Asa'),
...
dungeonList['Frost Cavern'] = new Dungeon('Frost Cavern',
    [
        ...
        new DungeonTrainer('Brains & Brawn',
            ...
            { weight: 1, doubleBattle: true }, 'Eoin & Wolf'),
        new DungeonTrainer('Black Belt',
            [
...
dungeonList['Terminus Cave'] = new Dungeon('Terminus Cave',
    ...
    [
        new DungeonTrainer('Pokémon Rangers',
            ...
            ], { weight: 3, doubleBattle: true }, 'Fern & Lee'),
...
dungeonList['Victory Road Kalos'] = new Dungeon('Victory Road Kalos',
    [
        ...
        new DungeonTrainer('Brains & Brawn',
            ...
            { weight: 1, doubleBattle: true }, 'Arman & Hugo'),
...
dungeonList['Malie Garden'] = new Dungeon('Malie Garden',
    [
        ...
        new DungeonTrainer('Tourist Couple',
            ...
            ], { weight: 1, doubleBattle: true }, 'Landon and Yukiro'),
    ],
    {
        common: [
            {loot: 'xClick'},
...
dungeonList['Vast Poni Canyon'] = new Dungeon('Vast Poni Canyon',
    [
        ...
        new DungeonTrainer('Ace Duo',
            ...
            ], { weight: 1, doubleBattle: true }, 'Kent and Aimee'),
        new DungeonTrainer('Hiker',
            [
...
dungeonList['Mount Lanakila'] = new Dungeon('Mount Lanakila',
    [
        ...
        new DungeonTrainer('Master & Apprentice',
            ...
            ], { weight: 1, doubleBattle: true }, 'Breon and Kaimana'),
        new DungeonTrainer('Hiker',
